...
function Get_info(){
    ...
    var pri_old=document.getElementById("giacu").value
    var inf_pro=document.getElementById("tt").value
    ...
    if(n_pro!="" && img_pro!=""&& pri_pro!="" && pri_old!="" && inf_pro!=""){
        array.push(mang)
...
function Them(index){
    ...
    document.getElementById("giacu").value=array[index].Pri_old
    document.getElementById("tt").value=array[index].inf-pro
}
...
function list_product(){
    ...
    for(var i=0;i<array.length;i++){
        ...
        <div class="card-body">
            ...
            <p class="card-text">${array[i].Pri_old}</p>
            <p class="card-text">${array[i].inf_pro}</p>
